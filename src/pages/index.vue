...
<template>
  <div
    class="flex flex-col justify-evenly items-center h-52 w-full bg-fixed bg-cover bg-center bg-no-repeat bg-[url('https://i.ibb.co/gSYkT3J/bg-img-2.jpg')]  bg-gray-900 ">
  ...
  <div v-else
    class="grid p-2 place-items-center w-full grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
